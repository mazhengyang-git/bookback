  ...
  <div class="wave">
    ...
    <div class="buttrq">
      ...
      <div style="position: relative; white-space: nowrap; left: -69px; margin-right: 40px">
        <el-button class="huodong-button1" type="primary" @click="router.push('/')"
          >返回首页</el-button
        >
        <el-button
        ...
        <el-button
          ...
          >图书资讯</el-button
        >
        <el-button class="huodong-button" type="primary" @click="router.push('/books')"
          >图书商城</el-button
        >
      </div>
      <!-- 未登录 -->
...
// import { useZixunStore } from '@/store/zixun'
// import { useHuodongStore } from '@/store/huodong'
...
// 获取活动列表
async function getHuodongList(huodongList: any) {
